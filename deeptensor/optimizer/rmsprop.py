...
class TFRMSprop(optim.Optimizer):
    ...
    def __init__(self, params, lr=1e-3, weight_decay=1e-5, rho=0.9, eps=1e-3, momentum=0.9):
        """
        ...
        """
        defaults = dict(lr=lr, weight_decay=weight_decay, rho=rho, eps=eps, momentum=momentum)
