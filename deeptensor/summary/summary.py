...
def summary_model_keras(model, input_size, batch_size=-1, device="cuda"):
    ...
    def register_hook(module):
        ...
        def hook(module, input, output):
            ...
            params = 0
            summary[m_key]["weight_size"] = [0]
            summary[m_key]["bias_size"] = [0]
    ...
    tmpstr += "---------------------------------------------------------------------------------------------------------------"
    tmpstr += '\n'
    line_new = "{:>20}  {:>20} {:>20} {:>20} {:>10} {:>15}".format("Layer (type)", "Input Shape", "Output Shape", "Weight Size", "Bias Size", "Param #")
    tmpstr += line_new
    tmpstr += '\n'
    tmpstr += "==============================================================================================================="
    tmpstr += '\n'
    ...
    for layer in summary:
        ...
        line_new = "{:>20}  {:>20} {:>20} {:>20} {:>10} {:>15}".format(
            layer,
            str(summary[layer]["input_shape"]),
            str(summary[layer]["output_shape"]),
            str(summary[layer]["weight_size"]),
            str(summary[layer]["bias_size"]),
